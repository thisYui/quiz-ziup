class MatchingOption < ApplicationRecord
  belongs_to :question
  has_many :left_results, class_name: "MatchingResult", foreign_key: :option_left_id, dependent: :destroy
  has_many :right_results, class_name: "MatchingResult", foreign_key: :option_right_id, dependent: :destroy
